...
const index1 = () => {
  ...
  {/* <img id="navbar-section-logo" src='/img/logo.jpg'> */}
  {/* </a> */}
  ...
  {/* </div>
          ...
          <a href="https://htmlcodex.com/startup-company-website-template" class="btn btn-primary py-2 px-4 ms-3">Contact Now</a>
      </div>
  </nav> */}
          ...
          <div class="carousel-item active">
              ...
              <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                  <div class="p-3" style="max-width: 900px;">
                      ...
                      <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"><input type="email" placeholder="abc@gmail.com"</a>
                      <a href="" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Yes I'm Interested</a>
                  </div>
              </div>
          </div>
